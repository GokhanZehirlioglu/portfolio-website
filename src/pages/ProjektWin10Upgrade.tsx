        ...
        <Layout>
            ...
            >
                ...
                <div className="relative z-10 max-w-3xl mx-auto px-6 py-14">
                    ...
                    <nav className="flex items-center gap-2 text-xs text-white/50 mb-7 flex-wrap">
                        ...
                        <span className="opacity-40">›</span>
                        <span>Modul 1: Client OS Lifecycle</span>
                        <span className="opacity-40">›</span>
                    ...
                    <h1 className="text-3xl md:text-5xl font-bold leading-tight tracking-tight mb-3">
                        Upgrade<br />
                        <span style={{ color: "#4EA8DE" }}>Windows 10 → Windows 11</span>
                    </h1>
                    <p className="text-base text-white/60 max-w-xl leading-relaxed mb-8">
                        Ein bestehendes Betriebssystem ohne Datenverlust und ohne Neuinstallation direkt
                        auf Windows 11 aktualisieren — Schritt für Schritt dokumentiert.
                    </p>

                    {/* Meta pills */}
                    <div className="flex flex-wrap gap-5 mb-8">
                        {[
                            { Icon: Calendar, label: "18.03.2026" },
                            { Icon: Monitor, label: "Hyper-V auf Remote Desktop" },
                            { Icon: Server, label: "Gokhan Zehirlioglu" },
                        ].map(({ Icon, label }) => (
                    ...
                    <nav className="flex flex-wrap gap-2">
                        {[
                            { label: "01 Upgrade", active: true },
                            { label: "02 Migration (USMT)", active: false },
            ...
            <div className="bg-[#111111] text-slate-300">
                <div className="max-w-3xl mx-auto px-6">
                    ...
                    <section className="py-14 border-b border-white/5">
                        ...
                        <p className="text-sm leading-relaxed text-slate-400 mb-4">
                            Das Verfahren heißt <strong className="text-white">In-Place Upgrade</strong>. Im Gegensatz zu einer
                    ...
                    <section className="py-14 border-b border-white/5">
                        ...
                        <p className="text-sm leading-relaxed text-slate-400 mb-6">
                            Die virtuelle Maschine wurde in Hyper-V als <strong className="text-white">Generation 2</strong> erstellt —
                        ...
                        <ProofFigure
                            src={`${BASE}/projekt1_2.png`}
                            figNum="Abb. 1"
                            caption="winver — Windows 10 Pro, Version 22H2 (Build 19045.6456). Testdaten und Anwendungen auf dem Desktop sichtbar."
                            onZoom={zoom}
                        />
                        <ProofFigure
                            src={`${BASE}/projekt1_5.png`}
                            figNum="Abb. 2"
                            caption="msinfo32 — UEFI-Modus, Sicherer Startzustand: Ein, Systemmodell: Virtual Machine."
                            onZoom={zoom}
                        />
                    </section>
                    ...
                    <section className="py-14 border-b border-white/5">
                        ...
                        <p className="text-sm text-slate-400 mb-6 leading-relaxed">
                            Das Projekt wurde vollständig auf einem <strong className="text-white">Remote Desktop Server</strong> durchgeführt.
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 mb-6">
                            {archCards.map((card) => (
                                <div
                                    key={card.title}
                                    className="p-4 rounded-xl bg-[#1a1a1a] border border-white/5 hover:border-blue-500/30 transition-colors"
                                >
                                    <div
                        ...
                        <ProofFigure
                            src={`${BASE}/projekt1_1.png`}
                            figNum="Abb. 3"
                            caption="VM-Einstellungen — Sicherheit: Secure Boot aktiviert, TPM eingeschaltet. DVD-Laufwerk: Win11 ISO eingebunden."
                            onZoom={zoom}
                        />
                        <ProofFigure
                            src={`${BASE}/projekt1_4.png`}
                            figNum="Abb. 4"
                            caption={'tpm.msc \u2014 Status: "Das TPM ist einsatzbereit", Spezifikationsversion: 2.0, Hersteller: MSFT.'}
                            onZoom={zoom}
                        />
                    </section>
                    ...
                    <section className="py-14 border-b border-white/5">
                        ...
                        <Step num={1} title="Systemvoraussetzungen prüfen"
                            desc={<>Über <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">tpm.msc</code> wurde der TPM-Status geprüft (Version 2.0, einsatzbereit). Mit <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">msinfo32</code> wurde bestätigt, dass Secure Boot aktiviert ist und das System im UEFI-Modus läuft.</>}
                        />
                        <Step num={2} title="Testdaten auf dem Desktop anlegen"
                            desc='Zwei Ordner — "test datei" und "test datei 2" — wurden auf dem Desktop erstellt. Diese dienen als Beweis: Wenn sie nach dem Upgrade noch vorhanden sind, ist kein Datenverlust eingetreten.'
                        />
                        <Step num={3} title="Testanwendungen installieren und fixieren"
                            desc="Firefox und Spotify wurden installiert und in der Taskleiste fixiert. Fixierte Taskleisten-Icons bieten einen sofort sichtbaren visuellen Beweis für die erfolgreiche Anwendungsmigration."
                        />
                        <Step num={4} title="Hyper-V Checkpoint erstellen"
                            desc="Vor dem Upgrade wurde in Hyper-V ein Prüfpunkt erstellt (Zeitstempel: 17.03.2026, 12:37:24). Falls das Upgrade fehlschlägt, kann jederzeit zum vorherigen Zustand zurückgekehrt werden."
                        />
                        <ProofFigure
                            src={`${BASE}/projekt1_3.png`}
                            figNum="Abb. 5"
                            caption="Hyper-V Prüfpunkt — Erstellt am 17.03.2026, 12:37:24 als Rückfallsicherung vor dem Upgrade."
                            onZoom={zoom}
                        />

                        <PhaseLabel label="Phase 2 — Upgrade-Prozess" />
                        <Step num={1} title="Windows 11 ISO einbinden"
                            desc={<>Die Datei <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">MS-Win11_German_x64-Multi.iso</code> wurde in den Hyper-V-Einstellungen als DVD-Laufwerk in die VM eingebunden.</>}
                        />
                        <Step num={2} title="setup.exe starten"
                            desc={<>Die Datei <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">setup.exe</code> wurde direkt aus dem eingebundenen DVD-Laufwerk gestartet — <strong className="text-white">innerhalb der laufenden Windows-10-Umgebung</strong>. Das ist das Kernprinzip des In-Place Upgrades.</>}
                        />
                        <Step num={3} title="Upgrade-Option auswählen"
                            desc='Im Setup-Dialog wurde die Option "Persönliche Dateien und Apps behalten" ausgewählt.'
                        />
                        <Step num={4} title="Installation bestätigen und durchführen"
                            desc='Die Bestätigungsseite zeigt: "Windows 11 Pro installieren" und "Persönliche Dateien und Apps behalten". Der gesamte Prozess dauert je nach Hardware 30–60 Minuten.'
                        />
                        <ProofFigure
                            src={`${BASE}/projekt1_6.png`}
                            figNum="Abb. 6"
                            caption='Setup-Bestätigung — "Windows 11 Pro installieren" mit der Option "Persönliche Dateien und Apps behalten".'
                            onZoom={zoom}
                        />

                        <PhaseLabel label="Phase 3 — Nachbereitung & Verifizierung" />
                        <Step num={1} title="winver ausführen — Upgrade-Erfolg bestätigen"
                            desc={<>Nach dem Upgrade wurde <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">winver</code> ausgeführt. Das Ergebnis: <strong className="text-white">Windows 11 Pro, Version 21H2 (Build 22000.3260)</strong>.</>}
                        />
                        <Step num={2} title="Desktop-Dateien prüfen"
                            desc='Die Ordner "test datei" und "test datei 2" sind weiterhin auf dem Desktop vorhanden. Es ist kein Datenverlust eingetreten.'
                        />
                        <Step num={3} title="Anwendungen prüfen"
                            desc="Firefox und Spotify sind weiterhin in der Taskleiste sichtbar und funktionsfähig."
                        />
                        <Step num={4} title="Upgrade-Logs sichern"
                            desc={<>Die Log-Dateien <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">setupact.log</code> (152 MB) und <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">setuperr.log</code> (100 KB) wurden in den Ordner <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">C:\Proof</code> kopiert.</>}
                        />
                        <Step num={5} title="Neuen Checkpoint erstellen"
                            desc="Nach dem erfolgreichen Upgrade wurde ein neuer Hyper-V Prüfpunkt erstellt (18.03.2026, 13:33:31)."
                        />
                        <ProofFigure
                            src={`${BASE}/projekt1_7.png`}
                            figNum="Abb. 7"
                            caption="winver nach dem Upgrade — Windows 11 Pro, Version 21H2. Desktop-Ordner und Taskleisten-Apps sind erhalten geblieben."
                            onZoom={zoom}
                        />
                    </section>
                    ...
                    <section className="py-14 border-b border-white/5">
                        ...
                        <IssueCard
                            type="problem"
                            icon={AlertCircle}
                            title="Problem: Update-Schleife beim Setup-Start"
                            body={
                                <>Während des Starts der Installation versuchte das Setup, im Hintergrund Updates herunterzuladen.
                                Aufgrund eines <strong className="text-slate-300">Netzwerk-Engpasses in der virtualisierten Umgebung</strong> blieb
                                der Installationsassistent über längere Zeit im Ladebildschirm hängen.</>
                            }
                        />
                        <IssueCard
                            type="solution"
                            icon={CheckCircle2}
                            title="Lösung: Netzwerkverbindung temporär trennen"
                            body={
                                <>Der virtuelle Switch wurde während der Installation in den Hyper-V-Einstellungen kurzzeitig auf
                                <strong className="text-slate-300"> "Nicht verbunden"</strong> gesetzt. Dadurch wurde die Update-Suche übersprungen
                                und die Offline-Installation konnte ungehindert fortgesetzt werden.
                                <br /><br />
                                <span style={{ color: C }} className="font-semibold">Praxishinweis:</span> Dieses Vorgehen ist auch in realen
                                IT-Umgebungen ein bewährter Ansatz bei instabilen Netzwerkverbindungen.</>
                            }
                        />

                        <p className="text-sm font-semibold text-white mt-8 mb-3">Abweichungen vom Standardvorgehen:</p>
                        <NoteBlock title="Edition: Pro statt Enterprise"
                            text="Statt Windows 10 Enterprise wurde Windows 10 Pro verwendet. Das Upgrade auf Windows 11 Pro verlief problemlos — die Upgrade-Architektur arbeitet editionsübergreifend identisch." />
                        <NoteBlock title="Checkpoint-Benennung"
                            text='Statt einer manuellen Benennung (z. B. "VOR-UPGRADE") wurde die automatische Hyper-V-Zeitstempel-Bezeichnung beibehalten. Die Funktion als Rückfallsicherung ist identisch.' />
                        <NoteBlock title="Testanwendungen"
                            text="Statt 7-Zip oder Notepad++ wurden Firefox und Spotify gewählt und in der Taskleiste fixiert — die Beweiskraft ist visuell stärker und sofort erkennbar." />
                    </section>
                    ...
                    <section className="py-14 border-b border-white/5">
                        ...
                        <p className="text-sm text-slate-400 mb-6 leading-relaxed">
                            Das Upgrade von <strong className="text-white">Windows 10 Pro (22H2)</strong> auf{" "}
                            <strong className="text-white">Windows 11 Pro (21H2)</strong> wurde erfolgreich abgeschlossen.
                            Alle definierten Erfolgskriterien wurden erfüllt:
                        </p>
                        ...
                        >
                            ...
                            <p className="text-sm text-slate-400 leading-relaxed mb-3">
                                Das <strong className="text-white">Upgrade</strong> ist die effizienteste Methode, um ein bestehendes System
                                ohne Datenverlust auf eine neue Windows-Version zu aktualisieren. Im Gegensatz zur Migration (USMT) oder
                                zum Clean Install bleiben alle Programme, Einstellungen und Benutzerdaten vollständig erhalten.
                            </p>
                            <p className="text-sm text-slate-400 leading-relaxed">
                                Das Projekt zeigt, dass ein Upgrade auch in <strong className="text-white">virtualisierten Umgebungen</strong> zuverlässig
                                funktioniert, sofern TPM 2.0, Secure Boot und UEFI erfüllt sind.
                            </p>
                        </div>
                    </section>
                    ...
                    <section className="py-14">
                        ...
                        <p className="text-sm text-slate-400 mb-2 leading-relaxed">
                            Nach dem erfolgreichen Upgrade wurde ein neuer Checkpoint in Hyper-V erstellt. Das Thumbnail zeigt bereits
                            das Windows-11-Design:
                        </p>
                        <ProofFigure
                            src={`${BASE}/projekt1_8.png`}
                            figNum="Abb. 8"
                            caption="Hyper-V nach dem Upgrade — Neuer Checkpoint (18.03.2026, 13:33). Windows 11 Thumbnail sichtbar."
                            onZoom={zoom}
                        />
                        <p className="text-sm text-slate-400 mb-2 leading-relaxed">
                            Die Upgrade-Logs wurden im Ordner{" "}
                            <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">C:\Proof</code> gesichert.{" "}
                            <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">setupact.log</code> dokumentiert den gesamten Ablauf,{" "}
                            <code className="text-xs bg-white/5 px-1.5 py-0.5 rounded">setuperr.log</code> enthält nicht-kritische Fehler:
                        </p>
                        <ProofFigure
                            src={`${BASE}/projekt1_9.png`}
                            figNum="Abb. 9"
                            caption="setupact.log (152 MB) und setuperr.log (100 KB) — vollständige Dokumentation des Upgrade-Vorgangs im Proof-Ordner."
                            onZoom={zoom}
                        />
                        ...
                        <div className="flex items-center justify-between pt-6 border-t border-white/5 mt-8">
                            <div>
                                <p className="text-xs text-slate-600 mb-1">Nächstes Projekt</p>
                                <p className="text-sm font-semibold text-slate-400">Projekt 02: Migration (USMT)</p>
                            </div>
                            <div
            ...
            <footer className="py-10 text-center bg-[#0d0d0d] border-t border-white/5">
                <p className="text-xs text-slate-600">
                    <strong className="text-slate-500">Projekt 01 / 04</strong> — Microsoft Enterprise IT · Modul 1: Client OS Lifecycle &amp; Deployment
                </p>
                <p className="text-xs text-slate-700 mt-1">gokhanzehirlioglu.de · Gokhan Zehirlioglu · Fachinformatiker für Systemintegration</p>
            </footer>
        </Layout>
    );
};
