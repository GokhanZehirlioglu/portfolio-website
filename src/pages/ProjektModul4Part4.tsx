...
const plannedSections = [
    ...
    { id: "onboarding", label: "02 — Defender Onboarding (via Intune)" },
    { id: "baseline",   label: "03 — Security Baseline & Konfigurationsprofile" },
    { id: "asr",        label: "04 — Attack Surface Reduction (ASR) Rules" },
    { id: "edr",        label: "05 — EDR-Konfiguration & Live Response" },
    { id: "tvm",        label: "06 — Threat & Vulnerability Management Dashboard" },
    { id: "validation", label: "07 — Incident-Simulation, Validierung & Nachweise" },
];

const techStack = [
    { k: "Dienst",      v: "Microsoft Defender for Endpoint (Plan 2)" },
    { k: "Onboarding",  v: "Via Microsoft Intune — automatisch bei Enrollment" },
    { k: "EDR",         v: "Endpoint Detection & Response — Live Response" },
    { k: "ASR",         v: "Attack Surface Reduction Rules (Office, Script, Exploit)" },
    { k: "TVM",         v: "Threat & Vulnerability Management — CVE-Tracking" },
    { k: "Unternehmen", v: "Rhein-Neckar Solutions GmbH" },
];

const ProjektModul4Part4 = () => (
    <Layout>
        <Helmet>
            <title>Modul 4 — Part 4: Microsoft Defender for Endpoint — Gökhan Zehirlioglu</title>
            <meta name="description" content="EDR-Lösung für alle Unternehmensgeräte — Defender for Endpoint mit ASR, EDR und TVM konfigurieren." />
        </Helmet>
        ...
        <header className="relative overflow-hidden text-white" style={{ background: "linear-gradient(135deg, #030D1A 0%, #071628 50%, #0A2040 100%)" }}>
            ...
            <div className="relative z-10 max-w-[820px] mx-auto px-6 py-14">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    <span className="text-[11px] font-bold px-3 py-1 rounded-full uppercase tracking-widest" style={{ background: "#ffffff10", color: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.1)" }}>Modul 4 / Part 4</span>
                </div>
                <h1 className="text-[clamp(1.8rem,4vw,2.6rem)] font-bold leading-[1.2] tracking-tight mb-3">
                    Microsoft Defender<br /><span style={{ color: AZ }}>for Endpoint</span>
                </h1>
                <p className="text-[1.05rem] font-light text-white/65 leading-relaxed max-w-[580px] mb-8">
                    EDR-Lösung für alle Unternehmensgeräte ausrollen — Attack Surface Reduction, Endpoint Detection &amp; Response
                    und kontinuierliches Threat &amp; Vulnerability Management.
                </p>
                <div className="flex flex-wrap gap-6 mb-8">
                    ...
                    <div className="flex items-center gap-2 text-[13px] text-white/60"><Monitor size={14} className="opacity-60" /><strong className="text-white/90 font-medium">Defender</strong>&nbsp;+ Intune</div>
        ...
        <div style={{ background: "#070E1A", color: "#E2E8F0" }} className="min-h-screen">
            <div className="max-w-[820px] mx-auto px-6 py-12">
                ...
                <div className="flex items-center justify-between pt-6 border-t" style={{ borderColor: "#0078D420" }}>
                    <a href="/projekt/windows/modul-4/part-3" className="text-sm text-slate-500 hover:text-white transition-colors" style={{ textDecoration: "none" }}>← Part 3: PIM</a>
                    <a href="/projekt/windows/modul-4/part-5" className="inline-flex items-center gap-2 text-sm font-semibold px-4 py-2 rounded-lg" style={{ background: `${C}20`, color: AZ, border: `1px solid ${C}30`, textDecoration: "none" }}>
                        Part 5: Microsoft Sentinel <ArrowRight size={14} />
                    </a>
                </div>
            </div>
        </div>
...
export default ProjektModul4Part4;
