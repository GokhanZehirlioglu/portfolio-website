...
const plannedSections = [
    ...
    { id: "environment", label: "02 — Intune-Tenant Setup & Lizenzierung" },
    { id: "enrollment",  label: "03 — Enrollment-Konfiguration (Windows Autopilot)" },
    { id: "compliance",  label: "04 — Compliance Policies (Bitlocker, Firewall, AV)" },
    { id: "config",      label: "05 — Configuration Profiles & Einstellungskatalog" },
    { id: "apps",        label: "06 — App-Deployment (Win32 & Microsoft Store)" },
    { id: "validation",  label: "07 — Validierung, Monitoring & Geräte-Status" },
];

const techStack = [
    { k: "Dienst",         v: "Microsoft Intune (Endpoint Manager)" },
    { k: "Enrollment",     v: "Windows Autopilot — Zero-Touch Provisioning" },
    { k: "Compliance",     v: "Compliance Policies (Bitlocker, Firewall, Defender)" },
    { k: "Konfiguration",  v: "Configuration Profiles & Einstellungskatalog" },
    { k: "App-Deployment", v: "Win32 Apps, Microsoft Store for Business" },
    { k: "Unternehmen",    v: "Rhein-Neckar Solutions GmbH" },
];

const ProjektModul4Part1 = () => (
    <Layout>
        <Helmet>
            <title>Modul 4 — Part 1: Microsoft Intune & MDM — Gökhan Zehirlioglu</title>
            <meta name="description" content="Microsoft Intune für Gerätemanagement einrichten — Enrollment, Compliance Policies und App-Deployment." />
        </Helmet>
        ...
        <header className="relative overflow-hidden text-white" style={{ background: "linear-gradient(135deg, #030D1A 0%, #071628 50%, #0A2040 100%)" }}>
            ...
            <div className="relative z-10 max-w-[820px] mx-auto px-6 py-14">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    <span className="text-[11px] font-bold px-3 py-1 rounded-full uppercase tracking-widest" style={{ background: "#ffffff10", color: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.1)" }}>Modul 4 / Part 1</span>
                </div>
                <h1 className="text-[clamp(1.8rem,4vw,2.6rem)] font-bold leading-[1.2] tracking-tight mb-3">
                    Microsoft Intune<br /><span style={{ color: AZ }}>&amp; MDM</span>
                </h1>
                <p className="text-[1.05rem] font-light text-white/65 leading-relaxed max-w-[580px] mb-8">
                    Microsoft Intune als Unified Endpoint Management Lösung einrichten — Geräte-Enrollment via Autopilot,
                    Compliance Policies und App-Deployment für alle Unternehmensgeräte.
                </p>
                <div className="flex flex-wrap gap-6 mb-8">
                    ...
                    <div className="flex items-center gap-2 text-[13px] text-white/60"><Monitor size={14} className="opacity-60" /><strong className="text-white/90 font-medium">Microsoft 365</strong>&nbsp;+ Azure</div>
        ...
        <div style={{ background: "#070E1A", color: "#E2E8F0" }} className="min-h-screen">
            <div className="max-w-[820px] mx-auto px-6 py-12">
                ...
                <div className="flex items-center justify-between pt-6 border-t" style={{ borderColor: "#0078D420" }}>
                    ...
                    <a href="/projekt/windows/modul-4/part-2" className="inline-flex items-center gap-2 text-sm font-semibold px-4 py-2 rounded-lg" style={{ background: `${C}20`, color: AZ, border: `1px solid ${C}30`, textDecoration: "none" }}>
                        Part 2: Conditional Access <ArrowRight size={14} />
                    </a>
                </div>
            </div>
        </div>
...
export default ProjektModul4Part1;
