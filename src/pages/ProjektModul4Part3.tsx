...
const plannedSections = [
    ...
    { id: "pim-setup",   label: "02 — PIM aktivieren & Rollen-Inventur" },
    { id: "eligible",    label: "03 — Eligible Role Assignments konfigurieren" },
    { id: "jit",         label: "04 — Just-In-Time-Aktivierung & Zeitfenster" },
    { id: "approval",    label: "05 — Approval Workflow & Benachrichtigungen" },
    { id: "reviews",     label: "06 — Access Reviews & Regelmäßige Prüfung" },
    { id: "validation",  label: "07 — Validierung, Audit Logs & Nachweise" },
];

const techStack = [
    { k: "Dienst",       v: "Azure AD Privileged Identity Management (PIM)" },
    { k: "Prinzip",      v: "Least Privilege — Kein dauerhafter Admin-Zugriff" },
    { k: "Aktivierung",  v: "Just-In-Time (JIT) — zeitlich begrenzt (max. 8h)" },
    { k: "Workflow",     v: "Approval-basierte Aktivierung für Global Admin" },
    { k: "Überprüfung",  v: "Quartalsweise Access Reviews (automatisiert)" },
    { k: "Unternehmen",  v: "Rhein-Neckar Solutions GmbH" },
];

const ProjektModul4Part3 = () => (
    <Layout>
        <Helmet>
            <title>Modul 4 — Part 3: Privileged Identity Management — Gökhan Zehirlioglu</title>
            <meta name="description" content="Just-In-Time-Zugriff auf privilegierte Azure-Rollen mit PIM und Approval Workflow absichern." />
        </Helmet>
        ...
        <header className="relative overflow-hidden text-white" style={{ background: "linear-gradient(135deg, #030D1A 0%, #071628 50%, #0A2040 100%)" }}>
            ...
            <div className="relative z-10 max-w-[820px] mx-auto px-6 py-14">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                    ...
                    <span className="text-[11px] font-bold px-3 py-1 rounded-full uppercase tracking-widest" style={{ background: "#ffffff10", color: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.1)" }}>Modul 4 / Part 3</span>
                </div>
                <h1 className="text-[clamp(1.8rem,4vw,2.6rem)] font-bold leading-[1.2] tracking-tight mb-3">
                    Privileged Identity<br /><span style={{ color: AZ }}>Management (PIM)</span>
                </h1>
                <p className="text-[1.05rem] font-light text-white/65 leading-relaxed max-w-[580px] mb-8">
                    Just-In-Time-Zugriff auf privilegierte Azure-Rollen implementieren — kein dauerhafter Admin,
                    alles zeitlich begrenzt mit Approval-Workflow und lückenloser Protokollierung.
                </p>
        ...
        <div style={{ background: "#070E1A", color: "#E2E8F0" }} className="min-h-screen">
            <div className="max-w-[820px] mx-auto px-6 py-12">
                ...
                <div className="flex items-center justify-between pt-6 border-t" style={{ borderColor: "#0078D420" }}>
                    <a href="/projekt/windows/modul-4/part-2" className="text-sm text-slate-500 hover:text-white transition-colors" style={{ textDecoration: "none" }}>← Part 2: Conditional Access</a>
                    <a href="/projekt/windows/modul-4/part-4" className="inline-flex items-center gap-2 text-sm font-semibold px-4 py-2 rounded-lg" style={{ background: `${C}20`, color: AZ, border: `1px solid ${C}30`, textDecoration: "none" }}>
                        Part 4: Defender for Endpoint <ArrowRight size={14} />
                    </a>
                </div>
            </div>
        </div>
...
export default ProjektModul4Part3;
